...
<section class="bg-white dark:bg-gray-900">
  <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
    <a
      href="https://github.com/ashutosh7i/toolrack"
    ...
    >
      <span
        ...
        >New</span
      > <span class="text-sm font-medium">ToolRack is out! See what's new</span>
      <svg
        class="ml-2 w-5 h-5"
        fill="currentColor"
        viewBox="0 0 20 20"
    ...
    >
      All Dev Tools under one Umbrella☂️
    </h1>
    <p
      class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400"
    >
      ToolRack offers a suite of essential software development tools at one
      spot, made with Svelte.
    </p>
    <div
    ...
    <Heading tag="h2" class=" mb-10 text-center">Tools we Offer</Heading>
    <Card padding="none" size="xl" class="grid md:grid-cols-2">
      ...
      >
        ...
        >
          ...
          <p class="my-4 font-light">
            Encode/Decode base64 data, convert base64 to text or binary, and
            vice versa.
          </p>
        </blockquote>
        <figcaption
        ...
        >
          <GradientButton
            ...
            color="pinkToOrange"
            on:click={() => {
              location.href = "/base64utils";
            }}>/base64utils</GradientButton
          >
        </figcaption>
      </figure>
      <!-- Color Tools Card -->
      ...
      >
        ...
        >
          ...
          <p class="my-4 font-light">
            Pick and convert colors, generate color palettes, and explore
        ...
        >
          <GradientButton
            ...
            color="pinkToOrange"
            on:click={() => {
              location.href = "/colorutils";
            }}>/colorutils</GradientButton
          >
        </figcaption>
      </figure>
      <!-- CSS Tools Card -->
      ...
      >
        ...
        >
          ...
          <p class="my-4 font-light">
            Format, optimize, and manipulate CSS code, including selectors,
        ...
        >
          <GradientButton
            outline
            color="pinkToOrange"
            on:click={() => (location.href = "/cssutils")}
            >/cssutils</GradientButton
          >
        </figcaption>
      </figure>
      <!-- CSV Tools Card -->
      ...
      >
        ...
        >
          ...
          <p class="my-4 font-light">
            Manipulate CSV data, including parsing, formatting, and validating
            CSV files.
          </p>
        </blockquote>
        <figcaption
        ...
        >
          <GradientButton
            ...
            color="pinkToOrange"
            on:click={() => {
              location.href = "/csvutils";
            }}>/csvutils</GradientButton
          >
        </figcaption>
      </figure>
      <figure
      ...
      >
        ...
        >
          ...
          <p class="my-4 font-light">
            Manipulate and format HTML code, including validation, prettifying,
            and minification.
          </p>
        </blockquote>
        <figcaption
        ...
        >
          <GradientButton
            ...
            color="pinkToOrange"
            on:click={() => {
              location.href = "/htmlutils";
            }}>/htmlutils</GradientButton
          >
        </figcaption>
      </figure>
      <!-- Image Tools Card -->
      ...
      >
        ...
        >
          ...
          <p class="my-4 font-light">
            Manipulate images, including resizing, cropping, optimizing, and
        ...
        >
          <GradientButton
            ...
            color="pinkToOrange"
            on:click={() => {
              location.href = "/imageutils";
            }}>/imageutils</GradientButton
          >
        </figcaption>
      </figure>
      ...
      >
        ...
        >
          ...
          <p class="my-4 font-light">
            Manipulate and analyze JavaScript code, including minification,
        ...
        >
          <GradientButton
            ...
            color="pinkToOrange"
            on:click={() => {
              location.href = "/javascriptutils";
            }}>/javascriptutils</GradientButton
          >
        </figcaption>
      </figure>
      <!-- JSON Tools Card -->
      ...
      >
        ...
        >
          ...
          <p class="my-4 font-light">
            View, validate, format, and manipulate JSON data with ease.
          </p>
        </blockquote>
        <figcaption
          class="flex justify-center items-center space-x-3 rtl:space-x-reverse"
        >
          <GradientButton
            ...
            color="pinkToOrange"
            on:click={() => {
              location.href = "/jsonutils";
            }}>/jsonutils</GradientButton
          >
        </figcaption>
      </figure>
      <!-- Markdown Tools Card -->
      ...
      >
        ...
        >
          ...
          <p class="my-4 font-light">
            Create, edit, and preview Markdown documents effortlessly.
          </p>
        </blockquote>
        <figcaption
          class="flex justify-center items-center space-x-3 rtl:space-x-reverse"
        >
          <GradientButton
            ...
            color="pinkToOrange"
            on:click={() => {
              location.href = "/mdutils";
            }}>/mdutils</GradientButton
          >
        </figcaption>
      </figure>
      <!-- QR Code Tools Card -->
      ...
      >
        ...
        >
          ...
          <p class="my-4 font-light">
            Generate and decode QR codes for various types of content.
          </p>
        </blockquote>
        <figcaption
          class="flex justify-center items-center space-x-3 rtl:space-x-reverse"
        >
          <GradientButton
            ...
            color="pinkToOrange"
            on:click={() => {
              location.href = "/qrutils";
            }}>/qrutils</GradientButton
          >
        </figcaption>
      </figure>
      <!-- Regex Tools Card -->
      ...
      >
        ...
        >
          ...
          <p class="my-4 font-light">
            Test, validate, and analyze regular expressions for pattern
            matching.
          </p>
        </blockquote>
        <figcaption
        ...
        >
          <GradientButton
            ...
            color="pinkToOrange"
            on:click={() => {
              location.href = "/regexutils";
            }}>/regexutils</GradientButton
          >
        </figcaption>
      </figure>
      <!-- String Tools Card -->
      ...
      >
        ...
        >
          ...
          <p class="my-4 font-light">
            Perform various operations on strings, including manipulation,
        ...
        >
          <GradientButton
            ...
            color="pinkToOrange"
            on:click={() => {
              location.href = "/stringutils";
            }}>/stringutils</GradientButton
          >
        </figcaption>
      </figure>
      <!-- URL Tools Card -->
      ...
      >
        ...
        >
          ...
          <p class="my-4 font-light">
            Encode/decode URLs, extract components, and perform URL-related
            operations.
          </p>
        </blockquote>
        <figcaption
        ...
        >
          <GradientButton
            ...
            color="pinkToOrange"
            on:click={() => {
              location.href = "/urlutils";
            }}>/urlutils</GradientButton
          >
        </figcaption>
      </figure>
      <!-- XML Tools Card -->
      ...
      >
        ...
        >
          ...
          <p class="my-4 font-light">
            Manipulate and analyze XML data, including parsing, validation, and
            formatting.
          </p>
        </blockquote>
        <figcaption
        ...
        >
          <GradientButton
            ...
            color="pinkToOrange"
            on:click={() => {
              location.href = "/xmlutils";
            }}>/xmlutils</GradientButton
          >
        </figcaption>
      </figure>
    </Card>
    ...
    <div
      class="px-4 pt-10 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36"
    >
      <span class="font-semibold text-gray-400 uppercase"
        >To Be FEATURED IN</span
      >
      <div
